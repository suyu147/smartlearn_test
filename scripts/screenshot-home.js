...
(async () => {
  ...
  await page.goto('http://localhost:3001/home', { waitUntil: 'networkidle', timeout: 60000 });
  await page.waitForTimeout(2000);
  await page.screenshot({
    path: path.join('D:\\python\\docment\\smartlearn', 'home-screenshot.png'),
    fullPage: false,
  });
  await page.screenshot({
    path: path.join('D:\\python\\docment\\smartlearn', 'home-screenshot-full.png'),
    fullPage: true,
  });
  console.log('done');
  await browser.close();
